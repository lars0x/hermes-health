...
fn get_seed_biomarkers() -> Vec<NewBiomarker> {
    vec![
        // --- Lipid Panel ---
        bm("2093-3", "Total Cholesterol", &["TC", "Chol", "Cholesterol, Total", "CHOL"], "mg/dL", "Lipid Panel",
           Some(125.0), Some(200.0), Some(150.0), Some(180.0)),
        bm("13457-7", "LDL Cholesterol", &["LDL-C", "LDL", "Low Density Lipoprotein"], "mg/dL", "Lipid Panel",
           None, Some(130.0), None, Some(70.0)),
        bm("2085-9", "HDL Cholesterol", &["HDL-C", "HDL", "High Density Lipoprotein"], "mg/dL", "Lipid Panel",
        ...
        // --- Liver ---
        bm("1742-6", "ALT", &["Alanine Aminotransferase", "SGPT", "GPT"], "U/L", "Liver",
           Some(7.0), Some(56.0), Some(7.0), Some(30.0)),
        bm("1920-8", "AST", &["Aspartate Aminotransferase", "SGOT", "GOT"], "U/L", "Liver",
           Some(10.0), Some(40.0), Some(10.0), Some(30.0)),
        bm("2324-2", "GGT", &["Gamma-Glutamyl Transferase", "Gamma GT", "GGTP"], "U/L", "Liver",
        ...
        // --- Hematology (CBC) ---
        bm("718-7", "Hemoglobin", &["Hgb", "Hb", "HGB"], "g/dL", "Hematology",
           Some(13.0), Some(17.0), Some(14.0), Some(16.0)),
        bm("4544-3", "Hematocrit", &["Hct", "HCT", "Packed Cell Volume", "PCV"], "%", "Hematology",
           Some(38.0), Some(50.0), Some(40.0), Some(48.0)),
        bm("6690-2", "WBC", &["White Blood Cell Count", "Leukocytes", "White Blood Cells"], "10*3/uL", "Hematology",
        ...
        bm("789-8", "RBC", &["Red Blood Cell Count", "Erythrocytes", "Red Blood Cells"], "10*6/uL", "Hematology",
           Some(4.5), Some(5.5), Some(4.5), Some(5.5)),
        bm("787-2", "MCV", &["Mean Corpuscular Volume"], "fL", "Hematology",
